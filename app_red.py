...
class Nodo:
    ...
    def __init__(self, str_tipo):
        ...
        if str_tipo == 'alfa': #modelo de alto rendimiento
            self.mb_prom = 1.3
            self.costo_electrico = 0.0071 # pesos de consumo por minuto
        elif str_tipo == 'beta': #modelo de medio rendimiento
            self.mb_prom = 0.8
            self.costo_electrico = 0.0057
        elif str_tipo == 'gamma': #modelo de bajo rendimiento
            self.costo_electrico = 0.0043
            self.mb_prom = 0.6
        else:
            print("no existe ese tipo de nodo")
        self.costo_perdida = self.costo_electrico# se pierde el doble
